...
namespace noggit
{
  class tileset_array_handler
  {
  public:
    tileset_array_handler(int base_texture_unit) : _base_texture_unit(base_texture_unit) {}
    ~tileset_array_handler();
  ...
  private:
    ...
    static constexpr int textures_per_array = 64;
  };
}
